...
class NeuralDataLoad(object):
    def __init__(self, data_path = None):
        self.viola_detector_data = data_path
        path = utils.get_path(data_fold=utils.TRAINING, neural=True, in_or_out = utils.IN)
        self.background_FP_viola_path = '{}{}/falsepos_from_selective_search/'.format(path, self.viola_detector_data)
        self.thatch_metal_TP_viola_path = '{}{}/truepos_from_selective_search/'.format(path, self.viola_detector_data)
